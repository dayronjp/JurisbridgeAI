...
function Perfil() {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        const response = await axios.get(`https://jurisbridgeai-production.up.railway.app/api/users/profile?name=${name}`);
        setDescription(response.data.description || "");

        const avatarRes = await axios.get(`https://jurisbridgeai-production.up.railway.app/api/users/avatar/${name}`);
    ...
    const fetchAllUsers = async () => {
      try {
        const res = await axios.get("https://jurisbridgeai-production.up.railway.app/api/users/all");
        setUsers(res.data);
      } catch (err) {
  ...
  const handleAvatarChange = async (e) => {
    ...
    if (file) {
      try {
        ...
        await axios.put("https://jurisbridgeai-production.up.railway.app/api/users/update-avatar", formData, {
  ...
  const handleDescriptionSave = async (newDesc) => {
    try {
      await axios.put("https://jurisbridgeai-production.up.railway.app/api/users/update-description", {
        name,
        description: newDesc,
      });
    } catch (err) {
